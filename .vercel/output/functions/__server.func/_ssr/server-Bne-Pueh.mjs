...
//#region node_modules/.nitro/vite/services/ssr/assets/server-Bne-Pueh.js
var server_Bne_Pueh_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-uOhOT7lK.mjs");
...
var manifest = {
	...
	"65d9005d1b7cdb4d050cce73c4ab15ece8c7642241a0742a1084a688f4d178dd": {
		...
		importer: () => import("./stylist.functions-DLk7wUV-.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-OkviyfW0.mjs").then((n) => n.t),
...
//#endregion
export { server_Bne_Pueh_exports as i, createServerFn as n, getServerFnById as r, TSS_SERVER_FUNCTION as t };
