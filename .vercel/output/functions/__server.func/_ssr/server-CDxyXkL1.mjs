...
//#region node_modules/.nitro/vite/services/ssr/assets/server-CDxyXkL1.js
var server_CDxyXkL1_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BlE-BtN5.mjs");
...
var manifest = {
	...
	"65d9005d1b7cdb4d050cce73c4ab15ece8c7642241a0742a1084a688f4d178dd": {
		...
		importer: () => import("./stylist.functions-CtAtynLu.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-G_Q9TxVZ.mjs").then((n) => n.t),
...
//#endregion
export { server_CDxyXkL1_exports as i, createServerFn as n, getServerFnById as r, TSS_SERVER_FUNCTION as t };
