...
//#region node_modules/.nitro/vite/services/ssr/assets/server-D5qxpzfe.js
var server_D5qxpzfe_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DSr0i_Bw.mjs");
...
var manifest = {
	...
	"65d9005d1b7cdb4d050cce73c4ab15ece8c7642241a0742a1084a688f4d178dd": {
		...
		importer: () => import("./stylist.functions-Cpwk_Wnn.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cew3Veff.mjs").then((n) => n.t),
...
//#endregion
export { server_D5qxpzfe_exports as i, createServerFn as n, getServerFnById as r, TSS_SERVER_FUNCTION as t };
