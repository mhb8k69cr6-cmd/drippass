...
import { t as createSsrRpc } from "./createSsrRpc-C2TfbVYd.mjs";
import { a as stringType, i as objectType, n as enumType, r as numberType, t as arrayType } from "../_libs/zod.mjs";
import { a as EVENTS, i as DURATIONS, n as BRANDS, o as PRODUCTS, r as CATEGORIES, s as SIZES, t as BANNERS } from "./products-Bl5euSZz.mjs";
...
import { a as DialogFooter, c as Separator, i as DialogDescription$1, l as useLookbook, n as Dialog$1, o as DialogHeader, r as DialogContent$1, s as DialogTitle$1, t as Checkbox } from "./lookbook-awWZLNOs.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-B0TfYg7y.js
...
function LocationPickerDialog({ open, onOpenChange, onLocationSelect, initialLocation }) {
	...
	const detectLocation = () => {
		...
		navigator.geolocation.getCurrentPosition(() => {
			setDetecting(false);
			setInput("Delhi NCR");
			toast.success("Approximate area detected. Confirm it before saving.");
		}, () => {
			setDetecting(false);
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: `mt-1 text-xs ${product.rentalStatus === "AVAILABLE" ? "text-emerald-600" : "text-muted-foreground"}`,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								children: product.available ? size ? "Add to Rental Cart" : "Select a size" : "Waitlist unavailable"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								variant: "outline",
...
}).parse(data)).handler(createSsrRpc("6d73d27a3b838e93b57d60670dd1db87c1ede41e81234e4e508a7ff79388c185"));
createServerFn({ method: "POST" }).inputValidator((data) => SessionInput.parse(data)).handler(createSsrRpc("113bc625da4d7d83f8458b5e0967905617397a05d69b90d0b6093ce9727107ee"));
createServerFn({ method: "POST" }).inputValidator((data) => objectType({
	...SessionInput.shape,
	productId: stringType().min(1)
}).parse(data)).handler(createSsrRpc("f754172c5ac62c5760a0ae49c3d794ed6566e31bad3c73ae510faecdedcf4efc"));
createServerFn({ method: "POST" }).inputValidator((data) => objectType({
	...SessionInput.shape,
	productId: stringType().min(1),
	rating: numberType().int().min(1).max(5),
	body: stringType().trim().min(10).max(2e3)
}).parse(data)).handler(createSsrRpc("5cb1a00e027dbd8f98745a9a23563d71b9b13a375249785d8b6651de49c7a3e0"));
var SLOTS = [
	"Tomorrow · 9AM–12PM",
	"Tomorrow · 4PM–8PM",
	"Sat · 9AM–12PM",
...
function CartSheet({ open, onOpenChange, items, onRemove }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sheet, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent$1, {
				className: "rounded-none sm:max-w-md",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle$1, { children: "Rental checkout" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription$1, { children: "This is a mock payment walkthrough. No real payment is processed; a successful test creates a rental order." })] }), checkoutState === "success" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "No real payment was taken. Your rental order was recorded for this demo."
					})]
					...
					onSubmit: (event) => {
						...
						(async () => {
							try {
								...
								new Date(start.getTime() + Math.max(1, Math.max(...items.map((item) => item.days))) * 864e5);
								const result = await createOrder({ data: {
									...
									items: items.map(({ product, days, size }) => ({
										...
										end: new Date(start.getTime() + days * 864e5).toISOString().slice(0, 10)
									}))
								} });
							...
							children: ["Manage your subscription pass and VIP benefits here.", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										size: "sm",
										className: "rounded-none bg-gradient-neon text-foreground",
										onClick: () => window.location.assign("/passes"),
										children: "Manage Pass"
									})
								]
							})]
...
function Home() {
	...
	(0, import_react.useEffect)(() => {
		const syncCart = () => {
			try {
				setCart(JSON.parse(window.localStorage.getItem("drippass.cart") ?? "[]"));
			} catch {
				setCart([]);
			}
	...
	const addToCart = (product, days, size) => {
		if (!product.available) {
			toast.error("Waitlist is unavailable: no persistence service is configured.");
			return;
		}
		setCart((c) => {
			const next = c.some((i) => i.product.id === product.id) ? c : [...c, {
				product,
				days,
				size
			}];
