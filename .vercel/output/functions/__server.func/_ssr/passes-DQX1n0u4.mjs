...
import { r as getPassState, t as PASS_PLANS } from "./pass.functions-D8y6P_Ll.mjs";
import { t as currentAccessToken } from "./pass-client-Cfn6ZOcP.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/passes-DQX1n0u4.js
	...
	const choose = async (planId) => {
		if (planId === "FREE") {
			...
			await supabase.auth.signInWithOAuth({
				provider: "google",
				options: { redirectTo: `${window.location.origin}/passes` }
			});
			return;
		}
		toast.info("Paid pass upgrades will activate after billing and webhook configuration.");
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [pass && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
