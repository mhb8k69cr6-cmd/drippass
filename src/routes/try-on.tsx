      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-10">
          <section className="mb-6 border border-border bg-card p-5 shadow-soft">
            ...
            <a href="https://gemini.google.com/images" target="_blank" rel="noreferrer" className="mt-3 inline-flex items-center gap-2 text-xs underline"><ExternalLink className="size-3.5" /> Open Gemini Images</a>
          </section>
          <AIStudio
            product={product}
